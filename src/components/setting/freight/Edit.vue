                ...
                that.$http({
                          ...
                          params:{
                            ...
                            if(res.data.error==0){ 
                                ...
                                that.fields.cash_on_delivery = Flist.cash_on_delivery;
                                that.fields.insured_cost = Flist.insured_cost;
                                that.fields.remark = Flist.remark;
                                that.fields.calculation = Flist.calculation;
                                that.fields.unit_freight = Flist.unit_freight;
