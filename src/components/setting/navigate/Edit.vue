              ...
              <vue-form :state="formstate" @submit.prevent="onSubmit" class="form-horizontal m-t">
                ...
                <div class="form-group draggable ui-draggable">
                  <div class="col-sm-12 col-sm-offset-3">
                    ...
                    <router-link to="/setting/navigation/list" class="btn btn-white m-l-sm">返回列表</router-link>-->
                    <el-button type="primary" native-type="submit">确定</el-button>
                    <router-link to="/setting/navigation/list" class="white-btn m-l-sm">返回列表</router-link>
                  </div>
                </div>
              </vue-form>
            </div>
      ...
      InfoData(id){
          ...
          that.$http({
                    ...
                    params:{
                      ...
                      if(res.data.error==0){ 
                          that.fields.id = id;                               
                          that.fields.nav_parent = Flist.nav_parent;                                
                          that.fields.sys_nav_name = Flist.sys_nav_name;
                          that.fields.nav_point = Flist.nav_point;
                          that.fields.remark = Flist.remark;
                          that.fields.open_new_window = Flist.open_new_window;
                          that.fields.open_type = Flist.open_type;
                          that.fields.sort = Flist.sort;
                          that.fields.link = Flist.link;                         
                      }else{
                          this.$message({
                            type: 'error',
