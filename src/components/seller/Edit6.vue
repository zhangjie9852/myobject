            ...
            <div class="ibox-content">
                <vue-form :state="formstate" @submit.prevent="onSubmit" class="form-horizontal m-t">                  
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <uediter :value="fields.shop_address_details" :config="config" @input="setContent" ></uediter>
                    </div>
                  </div>
  ...
  export default{
    ...
    methods: {
      ...
      setContent:function(input){
          var that = this;
          that.fields.shop_address_details = input.content;
      },
      getInfo (id) {
        var that=this;
        that.$http({
          ...
          if(res.data.error=='0'){
            ...
            that.fields={
              ...
              shop_modes:list.shop_modes,
              shop_keyword:list.shop_keyword,
              shop_linkman:list.shop_linkman,
              shop_linkman_mobile:list.shop_linkman_mobile,
              shop_province_id:list.shop_province_id,
              shop_area_id:list.shop_area_id,
              shop_city_id:list.shop_city_id,
              shop_address:list.shop_address,
              shop_address_details:list.shop_address_details,
              description:list.description,
              shop_notice:list.shop_notice,
              shop_state:list.shop_state,
              email:list.email              
            }
            that.shop_name = list.shop_name;
      ...
      nameIsExist () {//验证名称
        var that=this;
        if(that.fields.shop_name!=that.shop_name){
          that.$http({
            method:'post',
