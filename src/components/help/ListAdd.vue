          ...
          <div class="ibox float-e-margins">
            <div class="ibox-content p-m">
              ...
              <el-tabs v-model="activeName" type="card">
                ...
                <el-tab-pane label="帮助信息内容" name="second" :disabled="true"></el-tab-pane>
        ...
        if (this.formstate.$valid) {
          that.$http({
            ...
            if(res.data.error=='0'){
              ...
              that.$router.push('/help/list/edit/'+res.data.data.article_id);
            }else{
              that.$message({
                type: 'error',
                message: res.data.desc
