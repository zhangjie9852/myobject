        ...
        <div class="col-lg-12">
          <div class="ibox float-e-margins">
            <div class="ibox-content p-m">
              <div class="hd-title">编辑帮助信息</div>
              <el-tabs v-model="activeName" type="card" @tab-click="changeTab">
                <el-tab-pane label="基本信息" name="first">
                  <vue-form :state="formstate" @submit.prevent="onSubmit" class="form-horizontal m-t">
                    <validate class="form-group">
                      <label class="col-sm-3 control-label"><span class="f-c-r">*</span> 帮助分类：</label>
                      <div class="col-sm-4">
                        ...
                        <field-messages name="article_cate_id" show="$touched || $submitted"
                          ...
                          <div slot="required" class="error">帮助分类不能为空</div>
                        </field-messages>
                      </div>
                    </validate>
                    <validate class="form-group">
                      <label class="col-sm-3 control-label"><span class="f-c-r">*</span> 帮助标题：</label>
                      <div class="col-sm-4">
                        ...
                        <field-messages name="article_title" show="$touched || $submitted"
                                        class="form-control-callback">
                          <div slot="required" class="error">帮助标题不能为空</div>
                        </field-messages>
                      </div>
                    </validate>
                    <field class="form-group">
                      <label class="col-sm-3 control-label">帮助来源：</label>
                      <div class="col-sm-4">
                    ...
                    <field class="form-group">
                      <label class="col-sm-3 control-label">帮助作者：</label>
                      <div class="col-sm-4">
                    ...
                    <div class="form-group draggable ui-draggable">
                      <div class="col-sm-12 col-sm-offset-3">
                        ...
                        <!--<router-link to="/help/list" class="btn btn-white m-l-sm">返回列表</router-link>-->
                        <el-button type="primary" native-type="submit">确定</el-button>
                        <router-link to="/help/list" class="white-btn m-l-sm">返回列表</router-link>
                      </div>
                    </div>
                  </vue-form>
                </el-tab-pane>
                <el-tab-pane label="帮助内容" name="second">
                  <div class="form-horizontal m-t">
                    <div class="form-group">
                      <label class="col-sm-3 control-label">帮助摘要：</label>
                      <div class="col-sm-6">
