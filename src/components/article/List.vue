          ...
          <div class="ibox float-e-margins">
            <div class="ibox-content">
              <form action="#" class="form-inline m-b-sm" role="form">
                ...
                <el-input class="m-r-sm m-b-sm" name="keyword" v-model="keyword" placeholder="文章内容"></el-input>
                <el-input class="m-r-sm m-b-sm" name="articleCateId" v-model="articleCateId" placeholder="文章分类ID"></el-input>
                ...
                <el-select class="m-r-sm m-b-sm" name="is_jump" v-model="isJump">
