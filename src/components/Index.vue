        ...
        <div class="wrapper wrapper-content animated fadeInRight">
            <div class="row">
                <div class="col-lg-3">
                    <div class="ibox clearfix count-con sales-count">
                        <div class="icon-box"><i class="icon_hb_sale"></i></div>
                        <div class="count-box">
                ...
                <div class="col-lg-3">
                    <div class="ibox clearfix count-con order-count">
                        <div class="icon-box"><i class="icon_hb_order"></i></div>
                        <div class="count-box">
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="ibox">
                        <div class="ibox-title">
                            <h5><i class="icon_bt_member text-orange"></i><span>会员信息</span></h5>
                            <div class="pull-right">（单位：个）</div>
                        </div>
                ...
                <div class="col-lg-6">
                    <div class="ibox">
                        <div class="ibox-title">
                            <h5><i class="icon_bt_orderm text-blue"></i><span>订单信息</span></h5>
                            <div class="pull-right">（单位：个）</div>
                        </div>
                        <div class="ibox-content">
                            <ul class="info-container clearfix">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="ibox">
                        <div class="ibox-title">
                            <h5><i class="icon_bt_orders text-red"></i><span>订单统计</span></h5>
                            <div class="pull-right text-red">月订单统计</div>
                        </div>
                        <div class="ibox-content">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="ibox">
                        <div class="ibox-title">
                            <h5><i class="icon_bt_sale text-cyan"></i><span>销售统计</span></h5>
                            <div class="pull-right text-blue">月销售额统计</div>
                        </div>
                        <div class="ibox-content">
