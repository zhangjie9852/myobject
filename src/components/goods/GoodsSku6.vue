            ...
            <table class="table table-bordered table-hover">
                ...
                <tbody>                                     
                    <tr v-for="(item,index) in skuList" :key="index" v-if="skuList">
                        ...
                        <td class="text-center"><input type="number" onmousewheel="return false;" class="w80" name="product_sku_price" v-model="skuList[index].product_sku_price"><i class="icon_l_add addPri" v-if="skuMsg.goods_wholesale==1" @click="openPriDialog(index)"></i></td>
                ...
                <div class="price-table">
                  ...
                  <div class="price-table-body">
                    <ul v-for="(item,index) in skuList[dialogInd].priceArr" :key="index">
                      <li><input type="text" name="min_omq" v-model="item.amount"></li>
                      <li><input type="text" name="min_omq" v-model="item.prix"></li>
                          ...
                          params:{
                            ...
                            if(res.data.error==0){                                
                                ...
                                for(var i=0;i<fieldList.length;i++){
                                  ...
                                  //console.log(price_wholesale_arr.wholesale_price);
                                    that.skuList.push({
