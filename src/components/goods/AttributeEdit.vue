...
<script>
	...
	export default{
        ...
        mounted(){          
            this.CatePrent();    //分类数据
            this.AttrList(this.$route.params.id)               
        },
        updated(){
            if(this.pageError){                            
                this.CatePrent();
            ...
            AttrList(cid){
                ...
                that.$http({
                          ...
                          params:{
                            ...
                            if(res.data.error==0){                                
                                //console.log(that.lists.category_id)
                                that.lists.cate_id = ListArr.cate_id;
                                that.lists.attribute_name = ListArr.attribute_name;
                                that.lists.status_attribute = ListArr.status_attribute;
                            }else{
