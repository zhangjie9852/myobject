							...
							<form action="" class="form-inline m-b-sm clearfix" role="form">
								<el-dropdown class="m-r-sm">
								  	...
								  	<el-dropdown-menu slot="dropdown">
									    <el-dropdown-item>
			                                <span @click="batchOpt('del','删除',0)">批量删除</span>
									    </el-dropdown-item>
									    <el-dropdown-item>
			                                <span @click="batchOpt('ishow','禁止显示',-1)">禁止显示</span>
									    </el-dropdown-item>
									    <el-dropdown-item>
			                                <span  @click="batchOpt('ishow','恢复显示',1)">恢复显示</span>
									    </el-dropdown-item>
								  	</el-dropdown-menu>
								</el-dropdown>
										...
										<tr v-for="(item,index) in clist">
											...
											<td class="opt">
                                                ...
                                                <ul v-show="item.isOptShow">
                                                    ...
                                                    <li><a @click="delOne(item.assessment_id)">删除</a></li>                                   
                                                </ul>
											</td>
										</tr>
                    				</tbody>
