  ...
  routes: [
    ...
    },
    {
      ...
      children: [
            ...
            { path: '/member/list/add', component: MemberAdd, name: 'MemberAdd'},
            { path: '/member/list/edit/:id', component: MemberEdit, name: 'MemberEdit'},
            { path: '/member/list/detail/:id', component: MemberDetail, name: 'MemberDetail'},
            ...
            { path: '/shop/list/add', component: SellerAdd, name: 'SellerAdd'},
            { path: '/shop/list/edit/:id', component: SellerEdit, name: 'SellerEdit'},
